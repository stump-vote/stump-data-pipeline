...
@pytest.mark.parametrize('d, expected', (
    ...
    (
        {'camelCase': {'moreCamelCase': 'foo', 'moreMoreCamelCase': {'evenMoreCamelCase': 'bar'}}, 'not_camel': 'baz'},
        {'camel_case': {'more_camel_case': 'foo', 'more_more_camel_case': {'even_more_camel_case': 'bar'}}, 'not_camel': 'baz'},     
    ),
    (
